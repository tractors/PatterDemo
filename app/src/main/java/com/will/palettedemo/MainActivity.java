...
import com.will.palettedemo.bean.ColorInfo;
import com.will.palettedemo.util.BannerImageLoader;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String TAG = "PaletteDemo";
     ...
     * @param color
     */
    private void setStatusBarColor(Activity activity, @ColorInt int color) {
