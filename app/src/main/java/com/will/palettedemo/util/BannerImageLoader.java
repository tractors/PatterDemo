package com.will.palettedemo.util;
...
/**
 * 统一的加载banner图片(各种类型的， 热门banner，视频banner，直播间广告banner,商城banner.....
 */
public class BannerImageLoader extends ImageLoader {
    ...
    public void displayImage(Context context, final Object path, ImageView imageView) {
        ...
        if (null != path){
            ...
            Glide.with(mContext).asBitmap().load(path.toString()).listener(new RequestListener<Bitmap>() {
                @Override
